package com.github.lemniscate.lib.rest.svc;

import com.github.lemniscate.lib.rest.repo.ApiResourceRepository;
import com.github.lemniscate.lib.rest.repo.specification.specification.GenericMapPathSpecification;
...
public class AbstractApiResourceService<E extends Identifiable<ID>, ID extends Serializable> {

    public AbstractApiResourceService(Class<E> domainClass, Class<ID> idClass) {
